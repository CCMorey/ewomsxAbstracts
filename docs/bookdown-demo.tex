...
Actions may be considered extensions of memory, affording strategies for preserving information beyond what the capacity of working memory might typically allow. While study of speech-based sensory-motor phenomena is quite advanced, understanding how spatial and haptic sensory and motor functions influence memory remains under-explored. \href{https://www.youtube.com/playlist?list=PLbongzUA9kncPEcvf1hoelXmfLciHMfnf}{Talks in this session} investigate non-speech sensory and motor influence on working memory, including motion, spatial awareness, and rhythmic pattern.
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=xy_hkVxfNns\&list=PLbongzUA9kncPEcvf1hoelXmfLciHMfnf\&index=8}{The Hebb repetition effect in reproduction of nonverbal rhythms}}{The Hebb repetition effect in reproduction of nonverbal rhythms}}\label{the-hebb-repetition-effect-in-reproduction-of-nonverbal-rhythms}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=AzFuQkpSfYQ\&list=PLbongzUA9kncPEcvf1hoelXmfLciHMfnf\&index=3}{Translating words into actions in working memory: a role for spatial-motoric coding in the enacted recall advantage}}{Translating words into actions in working memory: a role for spatial-motoric coding in the enacted recall advantage}}\label{translating-words-into-actions-in-working-memory-a-role-for-spatial-motoric-coding-in-the-enacted-recall-advantage}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=a9W-O_grerQ\&list=PLbongzUA9kncPEcvf1hoelXmfLciHMfnf\&index=4\&t=0s}{Visuospatial Bootstrapping: Spatialization facilitates verbal memory in a range of learning and memory tasks}}{Visuospatial Bootstrapping: Spatialization facilitates verbal memory in a range of learning and memory tasks}}\label{visuospatial-bootstrapping-spatialization-facilitates-verbal-memory-in-a-range-of-learning-and-memory-tasks}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=pN3N0eyRBL0\&list=PLbongzUA9kncPEcvf1hoelXmfLciHMfnf\&index=5}{Bootstrapping the visuospatial bootstrapping effect (and testing its spatialisation)}}{Bootstrapping the visuospatial bootstrapping effect (and testing its spatialisation)}}\label{bootstrapping-the-visuospatial-bootstrapping-effect-and-testing-its-spatialisation}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=_6ma87UZduI\&list=PLbongzUA9kncPEcvf1hoelXmfLciHMfnf\&index=6}{The role of verbal working memory in gesture/speech integration: The need of taking individual differences into account}}{The role of verbal working memory in gesture/speech integration: The need of taking individual differences into account}}\label{the-role-of-verbal-working-memory-in-gesturespeech-integration-the-need-of-taking-individual-differences-into-account}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=G2EEa0mDoAk\&list=PLbongzUA9kncPEcvf1hoelXmfLciHMfnf\&index=4}{Working memory at play: Two studies with volleyball players}}{Working memory at play: Two studies with volleyball players}}\label{working-memory-at-play-two-studies-with-volleyball-players}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=3G8cET0O5Iw\&list=PLbongzUA9kncPEcvf1hoelXmfLciHMfnf\&index=3\&t=0s}{Does sensorimotor arousal influence memory functioning? A test of embodied view of memory using short term immobilization}}{Does sensorimotor arousal influence memory functioning? A test of embodied view of memory using short term immobilization}}\label{does-sensorimotor-arousal-influence-memory-functioning-a-test-of-embodied-view-of-memory-using-short-term-immobilization}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=-feP6MTT-rw\&list=PLbongzUA9kncPEcvf1hoelXmfLciHMfnf\&index=2\&t=0s}{Inhibition of Return and/or facilitation in working memory?}}{Inhibition of Return and/or facilitation in working memory?}}\label{inhibition-of-return-andor-facilitation-in-working-memory}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=lcFYsB6C6ek\&list=PLbongzUA9kncPEcvf1hoelXmfLciHMfnf\&index=7}{Visuo-spatial working-memory In body-awareness: does recalling locations helps perceive its own body?}}{Visuo-spatial working-memory In body-awareness: does recalling locations helps perceive its own body?}}\label{visuo-spatial-working-memory-in-body-awareness-does-recalling-locations-helps-perceive-its-own-body}}
...
\hypertarget{how-verbalization-and-language-impact-working-memory}{%
\chapter{How verbalization and language impact working memory}\label{how-verbalization-and-language-impact-working-memory}}

How does verbalization impact memory for information, whether for words, images, or sounds? What does our understanding about interactions between verbalization and working memory performance suggest about the structure of a working memory system? \href{https://www.youtube.com/playlist?list=PLbongzUA9kndPFxbqu_jvA2oyy7AdHPSE}{Talks in this session} consider these topics.
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=xfySmou6tFk\&list=PLbongzUA9kndPFxbqu_jvA2oyy7AdHPSE\&index=4}{When does spontaneous verbal rehearsal emerge in children, and how does it affect memory recall? A multi-lab replication of Flavell, Beach and Chinsky (1966)}}{When does spontaneous verbal rehearsal emerge in children, and how does it affect memory recall? A multi-lab replication of Flavell, Beach and Chinsky (1966)}}\label{when-does-spontaneous-verbal-rehearsal-emerge-in-children-and-how-does-it-affect-memory-recall-a-multi-lab-replication-of-flavell-beach-and-chinsky-1966}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=slaiifXmW3E\&list=PLbongzUA9kndPFxbqu_jvA2oyy7AdHPSE\&index=5}{How do verbal labels influence children's visual working memory?}}{How do verbal labels influence children's visual working memory?}}\label{how-do-verbal-labels-influence-childrens-visual-working-memory}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=4y2fEWh88_o\&list=PLbongzUA9kndPFxbqu_jvA2oyy7AdHPSE\&index=3}{Short-term memory for music: the role of the vocal motor system?}}{Short-term memory for music: the role of the vocal motor system?}}\label{short-term-memory-for-music-the-role-of-the-vocal-motor-system}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=w48taKeak_E\&list=PLbongzUA9kndPFxbqu_jvA2oyy7AdHPSE\&index=6}{The role of working memory maintenance mechanisms in false recall}}{The role of working memory maintenance mechanisms in false recall}}\label{the-role-of-working-memory-maintenance-mechanisms-in-false-recall}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=cfXObos3IcM\&list=PLbongzUA9kndPFxbqu_jvA2oyy7AdHPSE\&index=2\&t=5s}{False memories in children's working memory}}{False memories in children's working memory}}\label{false-memories-in-childrens-working-memory}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=_7IVG-xiWGg\&list=PLbongzUA9kndPFxbqu_jvA2oyy7AdHPSE\&index=2}{Syntax, morphosyntax, and serial recall: How language supports short-term memory for order}}{Syntax, morphosyntax, and serial recall: How language supports short-term memory for order}}\label{syntax-morphosyntax-and-serial-recall-how-language-supports-short-term-memory-for-order}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=89QGpqjTuVw\&list=PLbongzUA9kndPFxbqu_jvA2oyy7AdHPSE\&index=8\&t=0s}{Short-term memory (digit) span scores as a consequence not cause of language learning}}{Short-term memory (digit) span scores as a consequence not cause of language learning}}\label{short-term-memory-digit-span-scores-as-a-consequence-not-cause-of-language-learning}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=Pfgap7sHQpY\&list=PLbongzUA9kndPFxbqu_jvA2oyy7AdHPSE\&index=7}{Working memory and language actions: Load effects on quality control in preschool children's production of novel syntax}}{Working memory and language actions: Load effects on quality control in preschool children's production of novel syntax}}\label{working-memory-and-language-actions-load-effects-on-quality-control-in-preschool-childrens-production-of-novel-syntax}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=ubHzb70Kxug\&list=PLbongzUA9knda4M-o-Z3LKPIKqenWs8dX\&index=7\&t=0s}{Working memory and vocabulary breadth and depth: How they contribute to explain reading comprehension}}{Working memory and vocabulary breadth and depth: How they contribute to explain reading comprehension}}\label{working-memory-and-vocabulary-breadth-and-depth-how-they-contribute-to-explain-reading-comprehension}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=i7qXwsPe0Oo\&list=PLbongzUA9knda4M-o-Z3LKPIKqenWs8dX\&index=4}{Resource reallocation in working memory through semantic chunks: Computational and behavioural evidence}}{Resource reallocation in working memory through semantic chunks: Computational and behavioural evidence}}\label{resource-reallocation-in-working-memory-through-semantic-chunks-computational-and-behavioural-evidence}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=5RB3f6QQBF8\&list=PLbongzUA9knda4M-o-Z3LKPIKqenWs8dX\&index=4\&t=0s}{Does attentional refreshing modulate the associative relatedness effect in children and adults' working memory?}}{Does attentional refreshing modulate the associative relatedness effect in children and adults' working memory?}}\label{does-attentional-refreshing-modulate-the-associative-relatedness-effect-in-children-and-adults-working-memory}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=nq5wpNCGQAY\&list=PLbongzUA9knda4M-o-Z3LKPIKqenWs8dX\&index=2}{No detrimental effect of semantic similarity on order memory: Could an encoding benefit be the explanation?}}{No detrimental effect of semantic similarity on order memory: Could an encoding benefit be the explanation?}}\label{no-detrimental-effect-of-semantic-similarity-on-order-memory-could-an-encoding-benefit-be-the-explanation}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=kCJ_YMgOzME\&list=PLbongzUA9knda4M-o-Z3LKPIKqenWs8dX\&index=3}{The effects of spacing in incidental chunk learning}}{The effects of spacing in incidental chunk learning}}\label{the-effects-of-spacing-in-incidental-chunk-learning}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=LZ3JjaBf9Xo\&list=PLbongzUA9knda4M-o-Z3LKPIKqenWs8dX\&index=2\&t=0s}{Working memory and categorization: How people code information in working memory when items share features?}}{Working memory and categorization: How people code information in working memory when items share features?}}\label{working-memory-and-categorization-how-people-code-information-in-working-memory-when-items-share-features}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=jcmcKbpF28Y\&list=PLbongzUA9knda4M-o-Z3LKPIKqenWs8dX\&index=5}{Impacts of anxiety on executive and perceptual attention in visual working memory}}{Impacts of anxiety on executive and perceptual attention in visual working memory}}\label{impacts-of-anxiety-on-executive-and-perceptual-attention-in-visual-working-memory}}
...
\href{https://www.youtube.com/playlist?list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js}{Talks in this session} cover the nature of refreshing in WM and how refreshing supports maintenance. This includes investigation of the retro-cue effect and the mechanisms underlying it, as well as the relationship between retrospective attention and working memory. This session also covers the topic of how WM maintenance processes (e.g.~refreshing, binding) may change over the course of development/ageing.
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=JrI7khOJPIw\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=2\&t=0s}{Developmental changes in retrospective attention influence visual working memory precision}}{Developmental changes in retrospective attention influence visual working memory precision}}\label{developmental-changes-in-retrospective-attention-influence-visual-working-memory-precision}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=rHZk1l6hDsY\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=5}{On maintenance of continuous representation}}{On maintenance of continuous representation}}\label{on-maintenance-of-continuous-representation}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=70ZPB4Ss0VQ\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=11\&t=0s}{Investigating the differences between the types of bindings underlying working memory}}{Investigating the differences between the types of bindings underlying working memory}}\label{investigating-the-differences-between-the-types-of-bindings-underlying-working-memory}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=bx5_eICHhig\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=6}{Strategic prioritisation enhances young and older adults' visual feature binding in working memory}}{Strategic prioritisation enhances young and older adults' visual feature binding in working memory}}\label{strategic-prioritisation-enhances-young-and-older-adults-visual-feature-binding-in-working-memory}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=nHqxyHzdcTA\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=7}{Is inhibition in working memory domain-general? A study of age-related decline in cross-domain inhibitory abilities}}{Is inhibition in working memory domain-general? A study of age-related decline in cross-domain inhibitory abilities}}\label{is-inhibition-in-working-memory-domain-general-a-study-of-age-related-decline-in-cross-domain-inhibitory-abilities}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=mWgfLP39qJ4\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=2}{Working memory and attention: A computational model of retro-cue effects}}{Working memory and attention: A computational model of retro-cue effects}}\label{working-memory-and-attention-a-computational-model-of-retro-cue-effects}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=LEeee_U_ocw\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=3}{The involvement of domain-general attention in the refreshing frequency effect}}{The involvement of domain-general attention in the refreshing frequency effect}}\label{the-involvement-of-domain-general-attention-in-the-refreshing-frequency-effect}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=r_6E2e6R9Yw\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=4}{The efficiency of removal is independent from the accuracy of substitution in working memory updating}}{The efficiency of removal is independent from the accuracy of substitution in working memory updating}}\label{the-efficiency-of-removal-is-independent-from-the-accuracy-of-substitution-in-working-memory-updating}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=VsaFgy-IHs4\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=8}{Subsequent effects of free time on working memory performance}}{Subsequent effects of free time on working memory performance}}\label{subsequent-effects-of-free-time-on-working-memory-performance}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=YzyTVkwfMyU\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=2\&t=0s}{Freeing capacity in WM through the use of LTM representations}}{Freeing capacity in WM through the use of LTM representations}}\label{freeing-capacity-in-wm-through-the-use-of-ltm-representations}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=oVO6ixMAtWE\&list=PLbongzUA9knfpSnPZC3fidMH22VNgz5js\&index=9}{Dual-task costs in working memory}}{Dual-task costs in working memory}}\label{dual-task-costs-in-working-memory}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=c71SA0pK6cc\&list=PLbongzUA9knd6D4yfpa4_1lgtKNfXQ4Oa\&index=5\&t=0s}{The Hebb repetition effect in Complex span tasks: Evidence towards the position-item association as its underlying mechanism}}{The Hebb repetition effect in Complex span tasks: Evidence towards the position-item association as its underlying mechanism}}\label{the-hebb-repetition-effect-in-complex-span-tasks-evidence-towards-the-position-item-association-as-its-underlying-mechanism}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=4gwzJE5qZsw\&list=PLbongzUA9knd6D4yfpa4_1lgtKNfXQ4Oa\&index=1}{The effect of cognitive load in working memory tasks: Limited to the complex span paradigm?}}{The effect of cognitive load in working memory tasks: Limited to the complex span paradigm?}}\label{the-effect-of-cognitive-load-in-working-memory-tasks-limited-to-the-complex-span-paradigm}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=hDTT5Avhfuo\&list=PLbongzUA9knd6D4yfpa4_1lgtKNfXQ4Oa\&index=5}{From ``pure guess'' to ``absolute certain'': What influences confidence judgments in visual working memory?}}{From ``pure guess'' to ``absolute certain'': What influences confidence judgments in visual working memory?}}\label{from-pure-guess-to-absolute-certain-what-influences-confidence-judgments-in-visual-working-memory}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=IyOO2158KYM\&list=PLbongzUA9knd6D4yfpa4_1lgtKNfXQ4Oa\&index=7}{Does subjective awareness of working memory capacity limits improve with age?}}{Does subjective awareness of working memory capacity limits improve with age?}}\label{does-subjective-awareness-of-working-memory-capacity-limits-improve-with-age}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=9mWMDsbIrCc\&list=PLbongzUA9knd6D4yfpa4_1lgtKNfXQ4Oa\&index=2}{Where did the teddy bear go? Scaffolding maintenance strategies in visual working memory}}{Where did the teddy bear go? Scaffolding maintenance strategies in visual working memory}}\label{where-did-the-teddy-bear-go-scaffolding-maintenance-strategies-in-visual-working-memory}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=WD9Sebi7n0w\&list=PLbongzUA9knd6D4yfpa4_1lgtKNfXQ4Oa\&index=3}{On the development of working memory updating in preschoolers}}{On the development of working memory updating in preschoolers}}\label{on-the-development-of-working-memory-updating-in-preschoolers}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=elrPaV53t9I\&list=PLbongzUA9knd6D4yfpa4_1lgtKNfXQ4Oa\&index=6}{Assessing perceptual and internal attention in the aging mind}}{Assessing perceptual and internal attention in the aging mind}}\label{assessing-perceptual-and-internal-attention-in-the-aging-mind}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=s-JhqCPxPsc\&list=PLbongzUA9knd6D4yfpa4_1lgtKNfXQ4Oa\&index=9\&t=0s}{Collective working memory}}{Collective working memory}}\label{collective-working-memory}}
...
How are working memory processes implemented in the brain? \href{https://www.youtube.com/playlist?list=PLbongzUA9knfpedioaXZyborcu-QWUqj7}{The talks in this session} speak to this overarching question using quantitative modelling and neuroimaging methods. We will look at how neuroimaging can inform us about the state of representations in WM, compare quantitative predictions of different theories of distraction, and discuss the development of quantitative models of well-known experimental findings.
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=UHAQs2dvhyc\&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7\&index=7\&t=0s}{Does forgetting in working memory depend on the type of representation?}}{Does forgetting in working memory depend on the type of representation?}}\label{does-forgetting-in-working-memory-depend-on-the-type-of-representation}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=9ezLdbVmwh4\&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7\&index=4}{A neo-Piagetian perspective on complex span modelling}}{A neo-Piagetian perspective on complex span modelling}}\label{a-neo-piagetian-perspective-on-complex-span-modelling}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=kZdyRTv3i1w\&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7\&index=2}{The dynamic coding of working memory content over time: from sensory recruitment to a distributed representation}}{The dynamic coding of working memory content over time: from sensory recruitment to a distributed representation}}\label{the-dynamic-coding-of-working-memory-content-over-time-from-sensory-recruitment-to-a-distributed-representation}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=L3UNJVTXEKM\&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7\&index=3}{Precision of neural codes involved in storing phonological information in working memory}}{Precision of neural codes involved in storing phonological information in working memory}}\label{precision-of-neural-codes-involved-in-storing-phonological-information-in-working-memory}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=on5xC6mIrZo\&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7\&index=5}{An interactive activation model of verbal working memory: Simulating psycholinguistic effects}}{An interactive activation model of verbal working memory: Simulating psycholinguistic effects}}\label{an-interactive-activation-model-of-verbal-working-memory-simulating-psycholinguistic-effects}}

\emph{Benjamin Kowialiewski (Universitè Grenoble Alpes) \& Steve Majerus}

\emph{Email: \href{mailto:bkowialiewski@uliege.be}{\nolinkurl{bkowialiewski@uliege.be}}}

\textbf{Introduction}: Some theoretical accounts consider that the linguistic system is a core component of working memory (WM). Indeed, all levels of language processing (phonological, lexical and semantic) have been shown to support maintenance of verbal information as evidenced by different psycholinguistic effects in immediate serial recall tasks: items associated with richer linguistic knowledge lead to higher recall performance than items with poorer linguistic knowledge. Psycholinguistic effects can be explained, at least theoretically, by interactive activation models assuming constant interaction between adjacent levels of linguistic representations during verbal WM tasks. However, interactive activation models have not yet been implemented within a WM architecture so far.

\textbf{Method}: We built a linguistic architecture based on interactive activation principles that we integrated within a WM architecture in order to simulate psycholinguistic effects. The linguistic architecture is a three-layer neural network composed of a sub-lexical, lexical and semantic layers, with adjacent layers being linked via bi-directional connection weights. This linguistic architecture was integrated with the Start-End model of WM (Henson, 1998), in which the order of items within a WM sequence is represented by start and end vectors.

\textbf{Results}: Using the same architecture throughout all experiments, we were able to reproduce all major psycholinguistic effects (lexical frequency, phonological similarity, neighbourhood density, semantic relatedness and imageability effects) in a computational implementation of immediate serial recall.

\textbf{Conclusion}: The results of our simulations support interactive activation models, assuming that WM partially emerges from language processing, as a plausible mechanism for accounting for the presence of psycholinguistic effects on WM performance.

\hypertarget{putting-a-little-perception-for-action-into-working-memory-a-parametric-approach-to-auditory-distraction}{%
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=sOPQnA2l7EA\&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7\&index=7\&t=0s}{Putting a little perception-for-action into working memory? A parametric approach to auditory distraction}}{Putting a little perception-for-action into working memory? A parametric approach to auditory distraction}}\label{putting-a-little-perception-for-action-into-working-memory-a-parametric-approach-to-auditory-distraction}}
...
\subsection{\texorpdfstring{\href{https://www.youtube.com/watch?v=-Rwqd1wU4Bw\&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7\&index=1}{The role of control and scope of attention in maintaining information in working memory}}{The role of control and scope of attention in maintaining information in working memory}}\label{the-role-of-control-and-scope-of-attention-in-maintaining-information-in-working-memory}}
