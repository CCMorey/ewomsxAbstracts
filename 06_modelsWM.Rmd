...
How are working memory processes implemented in the brain? [The talks in this session](https://www.youtube.com/playlist?list=PLbongzUA9knfpedioaXZyborcu-QWUqj7) speak to this overarching question using quantitative modelling and neuroimaging methods. We will look at how neuroimaging can inform us about the state of representations in WM, compare quantitative predictions of different theories of distraction, and discuss the development of quantitative models of well-known experimental findings.
...
### [Does forgetting in working memory depend on the type of representation?](https://www.youtube.com/watch?v=UHAQs2dvhyc&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7&index=7&t=0s)
...
### [A neo-Piagetian perspective on complex span modelling](https://www.youtube.com/watch?v=9ezLdbVmwh4&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7&index=4)
...
### [The dynamic coding of working memory content over time: from sensory recruitment to a distributed representation](https://www.youtube.com/watch?v=kZdyRTv3i1w&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7&index=2)
...
### [Precision of neural codes involved in storing phonological information in working memory](https://www.youtube.com/watch?v=L3UNJVTXEKM&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7&index=3)
...
### [An interactive activation model of verbal working memory: Simulating psycholinguistic effects](https://www.youtube.com/watch?v=on5xC6mIrZo&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7&index=5)
...
### [Putting a little perception-for-action into working memory? A parametric approach to auditory distraction](https://www.youtube.com/watch?v=sOPQnA2l7EA&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7&index=7&t=0s)
...
### [The role of control and scope of attention in maintaining information in working memory](https://www.youtube.com/watch?v=-Rwqd1wU4Bw&list=PLbongzUA9knfpedioaXZyborcu-QWUqj7&index=1)
